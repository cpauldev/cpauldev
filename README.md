...
🦋 **[Ratekeepr](https://github.com/cpauldev/ratekeepr)**: A client-agnostic, multi-stage rate limiting engine for TypeScript, powered by @upstash/ratelimit. Designed for tiered pipelines (Global to Endpoint-level) with fail-open/fail-closed safety, supporting any Redis-compatible backend.
